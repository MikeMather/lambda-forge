...
;(() => {
  ...
  var Fe = (t, e, n, r) => {
    if ((e && typeof e == 'object') || typeof e == 'function') for (let i of Oe(e)) !Re.call(t, i) && i !== n && ne(t, i, { get: () => e[i], enumerable: !(r = Pe(e, i)) || r.enumerable })
    return t
  }
...
`,
      ...
      ;(t.Vector = function (e) {
        ...
        (t.Vector.prototype.dot = function (e) {
          for (var n = 0, r = this.elements, i = e.elements, s = r.length, o = i.length, a = 0, l = 0, u = 0, d = 0; u < s && d < o; ) (a = r[u]), (l = i[d]), a < l ? (u += 2) : a > l ? (d += 2) : a == l && ((n += r[u + 1] * i[d + 1]), (u += 2), (d += 2))
          return n
        }),
      ...
      ;(t.stemmer = (function () {
        var e = { ational: 'ate', tional: 'tion', enci: 'ence', anci: 'ance', izer: 'ize', bli: 'ble', alli: 'al', entli: 'ent', eli: 'e', ousli: 'ous', ization: 'ize', ation: 'ate', ator: 'ate', alism: 'al', iveness: 'ive', fulness: 'ful', ousness: 'ous', aliti: 'al', iviti: 'ive', biliti: 'ble', logi: 'log' },
          ...
          N = function (c) {
            ...
            if (((T = c.substr(0, 1)), T == 'y' && (c = T.toUpperCase() + c.substr(1)), (h = L), (x = f), h.test(c) ? (c = c.replace(h, '$1$2')) : x.test(c) && (c = c.replace(x, '$1$2')), (h = m), (x = S), h.test(c))) {
              var E = h.exec(c)
            ...
            return (h = z), (x = p), h.test(c) && x.test(c) && ((h = w), (c = c.replace(h, ''))), T == 'y' && (c = T.toLowerCase() + c.substr(1)), c
          }
        return function (R) {
          return R.update(N)
        }
      ...
      ;(t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
          for (var n = new t.Query(this.fields), r = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), l = 0; l < this.fields.length; l++) i[this.fields[l]] = new t.Vector()
          e.call(n, n)
      ...
      ;(t.Builder = function () {
        ...
        (function (e, n) {
          typeof define == 'function' && define.amd ? define(n) : typeof se == 'object' ? (oe.exports = n()) : (e.lunr = n())
        })(this, function () {
          return t
        })
    })()
  ...
  var U = class {
    constructor() {
      ...
      this.createComponents(document.body), this.ensureFocusedElementVisible(), this.listenForCodeCopies(), window.addEventListener('hashchange', () => this.ensureFocusedElementVisible()), document.body.style.display || (this.ensureFocusedElementVisible(), this.updateIndexVisibility(), this.scrollToHash())
    }
    createComponents(e) {
      re.forEach((n) => {
    ...
    showPage() {
      document.body.style.display && (console.log('Show page'), document.body.style.removeProperty('display'), this.ensureFocusedElementVisible(), this.updateIndexVisibility(), this.scrollToHash())
    }
    scrollToHash() {
      if (location.hash) {
    ...
    ensureFocusedElementVisible() {
      if ((this.alwaysVisibleMember && (this.alwaysVisibleMember.classList.remove('always-visible'), this.alwaysVisibleMember.firstElementChild.remove(), (this.alwaysVisibleMember = null)), !location.hash)) return
      let e = document.getElementById(location.hash.substring(1))
      if (!e) return
  ...
  function Ae(t, e, n, r) {
    ...
    n.addEventListener('keydown', (s) => {
      ;(i = !0), s.key == 'Enter' ? Ne(e, n) : s.key == 'Escape' ? n.blur() : s.key == 'ArrowUp' ? ue(e, -1) : s.key === 'ArrowDown' ? ue(e, 1) : (i = !1)
    }),
  ...
  function ce(t, e) {
    ...
    let n = t.toLocaleLowerCase(),
      ...
      s = 0,
      o = n.indexOf(r)
    for (; o != -1; ) i.push(K(t.substring(s, o)), `<b>${K(t.substring(o, o + r.length))}</b>`), (s = o + r.length), (o = n.indexOf(r, s))
  ...
  var X = class extends I {
    constructor(e) {
      super(e), (this.className = this.el.dataset.toggle || ''), this.el.addEventListener(H, (n) => this.onPointerUp(n)), this.el.addEventListener('click', (n) => n.preventDefault()), document.addEventListener(F, (n) => this.onDocumentPointerDown(n)), document.addEventListener(H, (n) => this.onDocumentPointerUp(n))
    }
    setActive(e) {
...
`),
  ...
  var Z = class extends I {
    constructor(e) {
      super(e), (this.summary = this.el.querySelector('.tsd-accordion-summary')), (this.icon = this.summary.querySelector('svg')), (this.key = `tsd-accordion-${this.summary.dataset.key ?? this.summary.textContent.trim().replace(/\s+/g, '-').toLowerCase()}`)
